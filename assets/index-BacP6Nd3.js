var ee=Object.defineProperty;var te=(i,e,t)=>e in i?ee(i,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):i[e]=t;var o=(i,e,t)=>te(i,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const l of a.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(n){if(n.ep)return;n.ep=!0;const a=t(n);fetch(n.href,a)}})();const $="6e400001-b5a3-f393-e0a9-e50e24dcca9e",se="6e400002-b5a3-f393-e0a9-e50e24dcca9e",ne="6e400003-b5a3-f393-e0a9-e50e24dcca9e",M=200,k=3e3;class ie{constructor(){o(this,"device",null);o(this,"server",null);o(this,"rxChar",null);o(this,"buffer","");o(this,"queue",[]);o(this,"notifyWaiters",[]);o(this,"_connected",!1);o(this,"opChain",Promise.resolve());o(this,"onDisconnectCallback",null);o(this,"disconnectUserInitiated",!1)}get connected(){return this._connected}drainQueue(){const e=[...this.queue];return this.queue=[],e}setOnDisconnect(e){this.onDisconnectCallback=e}async connect(){var n;if(!navigator.bluetooth)throw new Error("Web Bluetooth is not available in this browser.");this.device=await navigator.bluetooth.requestDevice({filters:[{services:[$]}],optionalServices:[$]}),this.device.addEventListener("gattserverdisconnected",()=>{var l;this._connected=!1;const a=this.disconnectUserInitiated;this.disconnectUserInitiated=!1,(l=this.onDisconnectCallback)==null||l.call(this,a)});const e=await((n=this.device.gatt)==null?void 0:n.connect());if(!e)throw new Error("GATT connect failed");this.server=e;const t=await this.server.getPrimaryService($);this.rxChar=await t.getCharacteristic(se);const s=await t.getCharacteristic(ne);await s.startNotifications(),s.addEventListener("characteristicvaluechanged",a=>{const c=a.target.value;if(!c)return;const v=new TextDecoder().decode(c);for(this.buffer+=v;this.buffer.includes(`
...
`);await this.rxChar.writeValueWithoutResponse(t)}async waitForLine(e){return this.queue.length?this.queue.shift():new Promise(t=>{const s=window.setTimeout(()=>{const a=this.notifyWaiters.indexOf(n);a>=0&&this.notifyWaiters.splice(a,1),t(null)},e),n=a=>{clearTimeout(s),t(a)};this.notifyWaiters.push(n)})}async send(e){return this.withLock(async()=>e?(await this.writeLine(e),this.collectLines(M,k)):this.collectLines(M,k))}async sendAndCollect(e,t=M,s=k,n){return this.withLock(async()=>(e&&await this.writeLine(e),this.collectLines(t,s,n)))}async collectLines(e,t,s){const n=[],a=Date.now()+t;for(;Date.now()<a;){const l=a-Date.now(),c=await this.waitForLine(Math.min(e,l));if(c===null){if(n.length)return n;continue}if(n.push(c),s!=null&&s(c,n))return n}return n}disconnect(){var e;this.disconnectUserInitiated=!0,(e=this.server)==null||e.disconnect(),this._connected=!1,this.device=null,this.server=null,this.rxChar=null,this.queue=[],this.notifyWaiters=[],this.opChain=Promise.resolve()}}const T=1,S=100,f=50,X=1,j=60,V=10;function p(i){const e=Math.round(Number(i));return Number.isFinite(e)?Math.max(T,Math.min(S,e)):f}function K(i){const e=Math.round(Number(i));return Number.isFinite(e)?Math.max(X,Math.min(j,e)):V}const J=250,ae=8e3,re=5e3,oe=200;function Q(i){const e=`OK ${i}`;return t=>t===e||t.startsWith(`${e} `)}function le(){const i=new Date(new Date().getFullYear(),0,1),e=new Date(new Date().getFullYear(),6,1),t=i.getTimezoneOffset(),s=e.getTimezoneOffset(),n=-t*60,l=t!==s?-Math.min(t,s)*60:0;return`TZ_OFFSET ${n} ${l}`}function ce(){const i=new Date,e=t=>String(t).padStart(2,"0");return`TIME ${i.getFullYear()}-${e(i.getMonth()+1)}-${e(i.getDate())} ${e(i.getHours())}:${e(i.getMinutes())}:${e(i.getSeconds())}`}function E(i){return i==="REQ_TIME"||i.startsWith("REQ_TIME ")}async function de(i){let e=i.drainQueue().some(E);if((await i.send(le())).some(E)&&(e=!0),!e){const s=Date.now()+2e3;for(;Date.now()<s;){const n=Math.max(100,Math.min(oe,s-Date.now())),a=await i.sendAndCollect("",n,Math.min(600,s-Date.now()),l=>E(l));if(a.some(E)){e=!0;break}if(!a.length)break}}}async function he(i){await i.send(ce())}async function D(i){return await he(i),me(i)}async function _(i){const e=await i.sendAndCollect("SCHED_GET",J,ae,Q("SCHED_GET"));if(!e.some(t=>t.startsWith("OK SCHED_GET")))throw new Error("SCHED_GET failed");return e}async function ue(i,e){const t=Object.keys(e);for(const n of t){const a=e[n];let l;a.enabled?l=`SCHED_DAY ${n} ${a.time} ${a.prewindowMin} ${a.pwmMax} ${a.postHoldMin}`:l=`SCHED_DAY ${n} OFF`;const c=await i.send(l);if(!c.some(v=>v.startsWith("OK SCHED_DAY")))throw new Error(`Failed to set ${n}: ${c.join(" ")}`)}if(!(await i.send("SAVE")).some(n=>n.includes("SAVE ok")))throw new Error("SAVE failed")}function pe(i){const e={};for(const t of i)t.startsWith("RTC: ")&&(e.rtc=t.slice(5)),t.startsWith("TODAY: ")&&(e.today=t.slice(7).trim()),t.startsWith("TODAY_ALARM: ")&&(e.todayAlarm=t.slice(13)),t.startsWith("ALARM(daily): ")&&(e.alarmDaily=t.slice(14)),t.startsWith("ALARM_AT: ")&&(e.alarmAt=t.slice(10)),t.startsWith("NEXT_RAMP: ")&&(e.nextRamp=t.slice(11)),t.startsWith("WAKE_CAUSE: ")&&(e.wakeCause=t.slice(12)),t.startsWith("BOOT_PATH: ")&&(e.bootPath=t.slice(11)),t.startsWith("NVM_OK: ")&&(e.nvmOk=t.includes("yes")),t.startsWith("PHASE: ")&&(e.phase=t.slice(7)),t.startsWith("TIME_SYNC_AUTO: ")&&(e.timeSync=t.slice(16)),t.startsWith("TIME_TRUSTED: ")&&(e.timeTrusted=t.includes("yes")),t.startsWith("PRE(min): ")&&(e.preMin=t.slice(10)),t.startsWith("POST_HOLD(min): ")&&(e.postHoldMin=t.slice(16));return e}async function me(i){const e=await i.sendAndCollect("STATUS_LITE",J,re,Q("STATUS_LITE"));if(e.some(t=>t.includes("ERR unknown cmd: STATUS_LITE")))return{};if(!e.some(t=>t.startsWith("OK STATUS_LITE")))throw new Error("STATUS_LITE failed");return pe(e)}async function fe(i,e,t){const s=await i.send(`LAMP_TEST ${e} ${t}`);if(!s.some(n=>n.startsWith("OK LAMP_TEST")))throw new Error(s.find(n=>n.startsWith("ERR"))??"LAMP_TEST failed")}async function be(i){const e=await i.send("LAMP_TEST_CANCEL");if(!e.some(t=>t==="OK LAMP_TEST_CANCEL"))throw new Error(e.find(t=>t.startsWith("ERR"))??"LAMP_TEST_CANCEL failed")}function ve(){return typeof navigator<"u"&&!!navigator.bluetooth}function ye(){return/iPad|iPhone|iPod/.test(navigator.userAgent)}function ge(){if(!ye())return!1;const i=navigator.userAgent;return/Safari/i.test(i)&&!/CriOS|FxiOS|EdgiOS/i.test(i)}const b=["mon","tue","wed","thu","fri","sat","sun"],Z="sml-draft-schedule-v2";function we(){return{enabled:!0,time:"07:00",prewindowMin:20,pwmMax:f,postHoldMin:20}}function C(){return Object.fromEntries(b.map(i=>[i,we()]))}function Te(){try{const i=localStorage.getItem(Z);if(i){const t=JSON.parse(i);return Y(t)}const e=localStorage.getItem("sml-draft-schedule-v1");if(e){const t=JSON.parse(e);return Y(t)}return null}catch{return null}}function Y(i){const e=C();for(const t of b){const s=i[t];s&&(e[t]={enabled:s.enabled,time:s.time,prewindowMin:s.prewindowMin??20,pwmMax:p(s.pwmMax??f),postHoldMin:s.postHoldMin??20})}return e}function u(i){localStorage.setItem(Z,JSON.stringify(i))}function A(i){const e=C();for(const t of i){const s=t.match(/^DAY\s+(mon|tue|wed|thu|fri|sat|sun)\s+(ON|OFF)\s+(\d{2}:\d{2})\s+(\d+)\s+(\d+)(?:\s+(\d+))?/i);if(!s)continue;const n=s[1].toLowerCase();e[n]={enabled:s[2].toUpperCase()==="ON",time:s[3],prewindowMin:Number(s[4]),pwmMax:p(Number(s[5])),postHoldMin:s[6]?Number(s[6]):20}}return e}function Se(i,e){return b.every(t=>JSON.stringify(i[t])===JSON.stringify(e[t]))}class Le{constructor(e){o(this,"root");o(this,"screen","connect");o(this,"transport",null);o(this,"schedule",Te()??C());o(this,"selected",new Set);o(this,"status",{});o(this,"message","");o(this,"messageKind","");o(this,"busy",!1);o(this,"scheduleLoading",!1);o(this,"statusLoading",!1);o(this,"syncGeneration",0);o(this,"lampTestLevel",f);o(this,"lampTestSeconds",V);o(this,"lampTestRemaining",0);o(this,"lampTestInterval",null);o(this,"lampTestExpanded",!1);this.root=e,this.render()}setMessage(e,t=""){this.message=e,this.messageKind=t,this.render()}async withBusy(e){this.busy=!0,this.render();try{await e()}catch(t){const s=t instanceof Error?t.message:String(t);this.setMessage(s,"error")}finally{this.busy=!1,this.render()}}async connectBle(){await this.withBusy(async()=>{const e=new ie;e.setOnDisconnect(t=>this.onTransportDisconnect(t)),await e.connect(),this.transport=e,this.screen="editor",this.status={},this.scheduleLoading=!0,this.statusLoading=!0,this.setMessage("Connected — loading schedule in background…","ok"),this.loadDeviceData(e,++this.syncGeneration)})}async loadDeviceData(e,t){try{if(await de(e),t!==this.syncGeneration)return;const s=await _(e);if(t!==this.syncGeneration)return;const n=await D(e);if(t!==this.syncGeneration)return;this.schedule=A(s),u(this.schedule),this.status=n,this.setMessage("Schedule loaded from mask.","ok")}catch(s){if(t!==this.syncGeneration)return;const n=s instanceof Error?s.message:String(s);this.setMessage(`Sync failed: ${n}`,"error")}finally{t===this.syncGeneration&&(this.scheduleLoading=!1,this.statusLoading=!1,this.render())}}clearLampTestUi(){this.lampTestInterval!==null&&(clearInterval(this.lampTestInterval),this.lampTestInterval=null),this.lampTestRemaining=0}async cancelLampTestOnDevice(e){var t;if(this.clearLampTestUi(),e&&((t=this.transport)!=null&&t.connected))try{await be(this.transport)}catch{}this.render()}onTransportDisconnect(e){const t=this.lampTestInterval!==null||this.lampTestRemaining>0;this.clearLampTestUi(),!e&&t&&window.alert("Bluetooth disconnected during the brightness test. The lamp should be off — reconnect if you want to try again."),e||(this.syncGeneration++,this.transport=null,this.screen="connect",this.selected.clear(),this.status={},this.scheduleLoading=!1,this.statusLoading=!1,this.setMessage(t?"Connection lost during brightness test.":"Bluetooth disconnected.","error"))}async disconnect(){var e;try{await this.cancelLampTestOnDevice(!0)}finally{this.syncGeneration++,(e=this.transport)==null||e.disconnect(),this.transport=null,this.screen="connect",this.selected.clear(),this.status={},this.scheduleLoading=!1,this.statusLoading=!1,this.setMessage("")}}async tryLampBrightness(){var s;if(!((s=this.transport)!=null&&s.connected)||this.busy)return;const e=p(this.lampTestLevel),t=K(this.lampTestSeconds);this.lampTestLevel=e,this.lampTestSeconds=t,this.lampTestExpanded=!0,await this.withBusy(async()=>{await fe(this.transport,e,t),this.clearLampTestUi(),this.lampTestRemaining=t,this.lampTestInterval=window.setInterval(()=>{this.lampTestRemaining=Math.max(0,this.lampTestRemaining-1);const n=this.root.querySelector("#lamp-test-countdown"),a=this.root.querySelector(".lamp-test-toggle-hint");n&&(n.textContent=this.lampTestRemaining>0?`Testing… ${this.lampTestRemaining}s left`:"Test finished"),a&&(a.textContent=this.lampTestRemaining>0?`Testing… ${this.lampTestRemaining}s left`:"Test finished"),this.lampTestRemaining<=0&&(this.clearLampTestUi(),this.render())},1e3),this.setMessage(`Trying ${e}% brightness for ${t}s…`,"ok")})}setLampTestLevel(e){this.lampTestLevel=p(e)}syncLampTestLevelInputs(){const e=this.root.querySelector("#lamp-test-level"),t=this.root.querySelector("#lamp-test-level-num");e&&(e.value=String(this.lampTestLevel)),t&&(t.value=String(this.lampTestLevel));const s=this.root.querySelector("#btn-lamp-test");s&&(s.textContent=`Try for ${this.lampTestSeconds}s`)}toggleLampTestPanel(){this.lampTestExpanded=!this.lampTestExpanded,this.render()}toggleDay(e){this.schedule[e].enabled=!this.schedule[e].enabled,u(this.schedule),this.render()}patchDay(e,t){Object.assign(this.schedule[e],t),u(this.schedule)}toggleSelect(e){this.selected.has(e)?this.selected.delete(e):this.selected.add(e),this.render()}applyBulk(e,t,s,n,a){const l=this.selected.size?[...this.selected]:b;for(const c of l)e==="time"&&t&&(this.schedule[c].time=t,this.schedule[c].enabled=!0),(e==="brightness"||e==="all")&&s!==void 0&&n!==void 0&&(this.schedule[c].prewindowMin=s,this.schedule[c].pwmMax=p(n),a!==void 0&&(this.schedule[c].postHoldMin=a)),e==="all"&&t&&(this.schedule[c].time=t,this.schedule[c].enabled=!0);u(this.schedule),this.render()}async saveToDevice(){if(!this.transport)return;if(!b.some(t=>this.schedule[t].enabled)){this.setMessage("Enable at least one day before saving.","error");return}await this.withBusy(async()=>{await ue(this.transport,this.schedule);const t=await _(this.transport),s=A(t);if(!Se(this.schedule,s))throw new Error("Device schedule does not match what was sent.");this.status=await D(this.transport),this.setMessage("Schedule saved to mask.","ok")})}async refreshFromDevice(){this.transport&&await this.withBusy(async()=>{const e=await _(this.transport);this.schedule=A(e),u(this.schedule),this.status=await D(this.transport),this.setMessage("Reloaded from mask.","ok")})}renderConnect(){const e=ve(),t=ge(),s=window.location.href;return`
        ...
        <div class="day-fields">
          ...
          <div class="field-row">
            <div>
              ...
              <input type="range" min="${T}" max="${S}" value="${t.pwmMax}" data-field="pwmMax" data-day="${e}" ${t.enabled?"":"disabled"} />
            </div>
            <div>
    ...
    `}renderEditor(){var n,a;const e=this.scheduleLoading,t=this.selected.size,s=t>0;return`
      ...
      ${s?`<div class="bulk-panel">
        <div class="card">
          ...
          <input type="range" id="bulk-max" min="${T}" max="${S}" value="${f}" />
      ...
      ${this.message?`<p class="message ${this.messageKind}">${this.message}</p>`:""}
    `}render(){this.root.innerHTML=this.screen==="connect"?this.renderConnect():this.renderEditor(),this.bindEvents()}bindEvents(){var a,l,c,v,g,y,w,x,O,B,R,I,N,q,W,H,P,U;(a=this.root.querySelector("#btn-connect"))==null||a.addEventListener("click",()=>void this.connectBle()),(l=this.root.querySelector("#btn-disconnect"))==null||l.addEventListener("click",()=>void this.disconnect()),(c=this.root.querySelector("#btn-save"))==null||c.addEventListener("click",()=>void this.saveToDevice()),(v=this.root.querySelector("#btn-refresh"))==null||v.addEventListener("click",()=>void this.refreshFromDevice()),this.root.querySelectorAll("[data-action='toggle']").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.day;this.toggleDay(d)})}),this.root.querySelectorAll("[data-action='select']").forEach(r=>{r.addEventListener("click",d=>{d.stopPropagation();const h=r.dataset.day;this.toggleSelect(h)})}),this.root.querySelectorAll("[data-field]").forEach(r=>{const d=r,h=d.dataset.day,m=d.dataset.field;if(m==="enabled")return;const F=()=>{if(m==="prewindowMin"||m==="pwmMax"||m==="postHoldMin"){const L=m==="pwmMax"?p(Number(d.value)):Number(d.value);this.patchDay(h,{[m]:L})}else this.patchDay(h,{[m]:d.value})};if(d.type==="range"){d.addEventListener("input",()=>{const L=p(Number(d.value));this.patchDay(h,{pwmMax:L});const G=d.previousElementSibling;G&&(G.textContent=`Brightness (${L}%)`)});return}d.addEventListener("change",F),d.addEventListener("blur",F)}),(g=this.root.querySelector('[data-preset="weekdays"]'))==null||g.addEventListener("click",()=>{for(const r of["mon","tue","wed","thu","fri"])this.schedule[r].enabled=!0,this.schedule[r].time="06:30";u(this.schedule),this.render()}),(y=this.root.querySelector('[data-preset="weekend"]'))==null||y.addEventListener("click",()=>{for(const r of["sat","sun"])this.schedule[r].enabled=!0,this.schedule[r].time="08:00";u(this.schedule),this.render()}),(w=this.root.querySelector('[data-preset="copy-mon"]'))==null||w.addEventListener("click",()=>{const r={...this.schedule.mon};for(const d of b)this.schedule[d]={...r};u(this.schedule),this.render()});const e=()=>{var r;return((r=this.root.querySelector("#bulk-time"))==null?void 0:r.value)??"07:00"},t=()=>{var r;return Number(((r=this.root.querySelector("#bulk-pre"))==null?void 0:r.value)??20)},s=()=>{var r;return Number(((r=this.root.querySelector("#bulk-hold"))==null?void 0:r.value)??20)},n=()=>{var r;return p(Number(((r=this.root.querySelector("#bulk-max"))==null?void 0:r.value)??f))};(x=this.root.querySelector("#btn-lamp-test-toggle"))==null||x.addEventListener("click",()=>{this.toggleLampTestPanel()}),(O=this.root.querySelector("#lamp-test-level"))==null||O.addEventListener("input",r=>{this.setLampTestLevel(Number(r.target.value)),this.syncLampTestLevelInputs()}),(B=this.root.querySelector("#lamp-test-level-num"))==null||B.addEventListener("input",r=>{this.setLampTestLevel(Number(r.target.value)),this.syncLampTestLevelInputs()}),(R=this.root.querySelector("#lamp-test-level-num"))==null||R.addEventListener("change",r=>{this.setLampTestLevel(Number(r.target.value)),this.syncLampTestLevelInputs()}),(I=this.root.querySelector("#lamp-test-level-num"))==null||I.addEventListener("blur",r=>{this.setLampTestLevel(Number(r.target.value)),this.syncLampTestLevelInputs()}),(N=this.root.querySelector("#lamp-test-seconds"))==null||N.addEventListener("change",r=>{const d=r.target;this.lampTestSeconds=K(Number(d.value)),d.value=String(this.lampTestSeconds);const h=this.root.querySelector("#btn-lamp-test");h&&(h.textContent=`Try for ${this.lampTestSeconds}s`)}),(q=this.root.querySelector("#btn-lamp-test"))==null||q.addEventListener("click",()=>void this.tryLampBrightness()),(W=this.root.querySelector("#btn-lamp-cancel"))==null||W.addEventListener("click",()=>{this.cancelLampTestOnDevice(!0),this.setMessage("Brightness test cancelled.","ok")}),(H=this.root.querySelector("#bulk-time-only"))==null||H.addEventListener("click",()=>{this.applyBulk("time",e())}),(P=this.root.querySelector("#bulk-bright-only"))==null||P.addEventListener("click",()=>{this.applyBulk("brightness",void 0,t(),n(),s())}),(U=this.root.querySelector("#bulk-all"))==null||U.addEventListener("click",()=>{this.applyBulk("all",e(),t(),n(),s())})}}const z=document.getElementById("app");z&&new Le(z);
