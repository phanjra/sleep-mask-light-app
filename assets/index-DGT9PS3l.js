var C=Object.defineProperty;var x=(n,e,t)=>e in n?C(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t;var c=(n,e,t)=>x(n,typeof e!="symbol"?e+"":e,t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))i(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function t(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(s){if(s.ep)return;s.ep=!0;const a=t(s);fetch(s.href,a)}})();const w="6e400001-b5a3-f393-e0a9-e50e24dcca9e",_="6e400002-b5a3-f393-e0a9-e50e24dcca9e",B="6e400003-b5a3-f393-e0a9-e50e24dcca9e",D=1e3,W=2e4;class q{constructor(){c(this,"device",null);c(this,"server",null);c(this,"rxChar",null);c(this,"buffer","");c(this,"queue",[]);c(this,"notifyWaiters",[]);c(this,"_connected",!1)}get connected(){return this._connected}async connect(){var s;if(!navigator.bluetooth)throw new Error("Web Bluetooth is not available in this browser.");this.device=await navigator.bluetooth.requestDevice({filters:[{services:[w]}],optionalServices:[w]}),this.device.addEventListener("gattserverdisconnected",()=>{this._connected=!1});const e=await((s=this.device.gatt)==null?void 0:s.connect());if(!e)throw new Error("GATT connect failed");this.server=e;const t=await this.server.getPrimaryService(w);this.rxChar=await t.getCharacteristic(_);const i=await t.getCharacteristic(B);await i.startNotifications(),i.addEventListener("characteristicvaluechanged",a=>{const d=a.target.value;if(!d)return;const f=new TextDecoder().decode(d);for(this.buffer+=f;this.buffer.includes(`
