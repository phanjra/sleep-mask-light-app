var mt=Object.defineProperty;var pt=(n,t,e)=>t in n?mt(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var o=(n,t,e)=>pt(n,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function e(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=e(i);fetch(i.href,r)}})();const T=1,E=100,I=50,st=1,it=60,nt=10;function v(n){const t=Math.round(Number(n));return Number.isFinite(t)?Math.max(T,Math.min(E,t)):I}function $(n){const t=n.trim();if(t==="")return null;const e=Number(t);return Number.isFinite(e)?Math.round(e):null}function j(n){const t=Math.round(Number(n));return Number.isFinite(t)?Math.max(st,Math.min(it,t)):nt}const g=["mon","tue","wed","thu","fri","sat","sun"],z=["sun","mon","tue","wed","thu","fri","sat"],ft={sun:"S",mon:"M",tue:"T",wed:"W",thu:"T",fri:"F",sat:"S"},J={mon:"Monday",tue:"Tuesday",wed:"Wednesday",thu:"Thursday",fri:"Friday",sat:"Saturday",sun:"Sunday"},rt="sml-draft-schedule-v2";function k(){return{enabled:!0,time:"07:00",prewindowMin:20,pwmMax:I,postHoldMin:20,oneShot:!1}}function Y(){return Object.fromEntries(g.map(n=>[n,k()]))}function gt(){try{const n=localStorage.getItem(rt);if(n){const e=JSON.parse(n);return Q(e)}const t=localStorage.getItem("sml-draft-schedule-v1");if(t){const e=JSON.parse(t);return Q(e)}return null}catch{return null}}function Q(n){const t=Y();for(const e of g){const s=n[e];s&&(t[e]={enabled:s.enabled,time:s.time,prewindowMin:s.prewindowMin??20,pwmMax:v(s.pwmMax??I),postHoldMin:s.postHoldMin??20,oneShot:!!s.oneShot})}return t}function w(n){localStorage.setItem(rt,JSON.stringify(n))}function B(n){const t=Y();for(const e of n){const s=e.match(/^DAY\s+(mon|tue|wed|thu|fri|sat|sun)\s+(ON|OFF)\s+(\d{2}:\d{2})\s+(\d+)\s+(\d+)(?:\s+(\d+))?(?:\s+(\d+))?/i);if(!s)continue;const i=s[1].toLowerCase();t[i]={enabled:s[2].toUpperCase()==="ON",time:s[3],prewindowMin:Number(s[4]),pwmMax:v(Number(s[5])),postHoldMin:s[6]?Number(s[6]):20,oneShot:s[7]!==void 0?Number(s[7])===1:!1}}return t}function yt(n,t){return g.every(e=>JSON.stringify(n[e])===JSON.stringify(t[e]))}function vt(n){return JSON.stringify({enabled:n.enabled,time:n.time,prewindowMin:n.prewindowMin,pwmMax:n.pwmMax,postHoldMin:n.postHoldMin,oneShot:!!n.oneShot})}function F(n,t){return g.indexOf(n)-g.indexOf(t)}function X(n){if(n.enabled||n.oneShot)return!1;const t=k();return n.time===t.time&&n.prewindowMin===t.prewindowMin&&n.pwmMax===t.pwmMax&&n.postHoldMin===t.postHoldMin}function L(n){const t=new Map;for(const i of g){const r=vt(n[i]),a=t.get(r)??[];a.push(i),t.set(r,a)}const e=[];let s=0;for(const i of t.values()){i.sort(F);const r={...n[i[0]]};e.push({id:`alarm-${s++}`,days:i,slot:r})}return e.sort((i,r)=>{const a=i.slot.time.localeCompare(r.slot.time);return a!==0?a:F(i.days[0],r.days[0])}),e}function Z(n){return L(n).filter(t=>!X(t.slot))}const bt=new Set(["mon","tue","wed","thu","fri"]),wt=new Set(["sat","sun"]);function St(n,t){if(t!=null&&t.oneShot)return"Once";if(n.length===0)return"No days";const e=[...n].sort(F);return e.length===7?"Every day":e.length===5&&e.every(s=>bt.has(s))?"Weekdays":e.length===2&&e.every(s=>wt.has(s))?"Weekend":e.length===1?J[e[0]]:e.map(s=>J[s].slice(0,3)).join(", ")}function Tt(n){return`${n.pwmMax}% brightness · ${n.prewindowMin} min ramp`}function Et(n,t,e=new Date){const s=n.match(/^(\d{1,2}):(\d{2})$/);if(!s)return t;const i=Number(s[1])*60+Number(s[2]),r=e.getHours()*60+e.getMinutes();if(i>r)return t;const a=g.indexOf(t);return g[(a+1)%7]}function at(){return{...k(),enabled:!1,oneShot:!1}}function Lt(n,t,e){const s={...n};for(const i of t.days)s[i]={...s[i],enabled:e,oneShot:e?s[i].oneShot:!1};return s}function Dt(n,t,e,s){const i={...n},r=new Set(e);for(const a of t)r.has(a)||(i[a]=at());for(const a of e)i[a]={...s};return i}function tt(n,t){const e={...n};for(const s of t.days)e[s]=at();return e}function Mt(n){const t=g.find(c=>!n[c].enabled),e=t??"sat",s={...k(),enabled:!0,time:t?"07:00":"08:00",oneShot:!1},i={...n,[e]:s},r=L(i),a=r.find(c=>c.days.includes(e)&&c.slot.time===s.time);return{schedule:i,groupId:(a==null?void 0:a.id)??r[r.length-1].id}}const H="6e400001-b5a3-f393-e0a9-e50e24dcca9e",$t="6e400002-b5a3-f393-e0a9-e50e24dcca9e",At="6e400003-b5a3-f393-e0a9-e50e24dcca9e",q=200,W=3e3;class Ct{constructor(){o(this,"device",null);o(this,"server",null);o(this,"rxChar",null);o(this,"buffer","");o(this,"queue",[]);o(this,"notifyWaiters",[]);o(this,"_connected",!1);o(this,"opChain",Promise.resolve());o(this,"onDisconnectCallback",null);o(this,"disconnectUserInitiated",!1)}get connected(){return this._connected}drainQueue(){const t=[...this.queue];return this.queue=[],t}setOnDisconnect(t){this.onDisconnectCallback=t}async connect(){var i;if(!navigator.bluetooth)throw new Error("Web Bluetooth is not available in this browser.");this.device=await navigator.bluetooth.requestDevice({filters:[{services:[H]}],optionalServices:[H]}),this.device.addEventListener("gattserverdisconnected",()=>{var a;this._connected=!1;const r=this.disconnectUserInitiated;this.disconnectUserInitiated=!1,(a=this.onDisconnectCallback)==null||a.call(this,r)});const t=await((i=this.device.gatt)==null?void 0:i.connect());if(!t)throw new Error("GATT connect failed");this.server=t;const e=await this.server.getPrimaryService(H);this.rxChar=await e.getCharacteristic($t);const s=await e.getCharacteristic(At);await s.startNotifications(),s.addEventListener("characteristicvaluechanged",r=>{const c=r.target.value;if(!c)return;const d=new TextDecoder().decode(c);for(this.buffer+=d;this.buffer.includes(`
...
`);await this.rxChar.writeValueWithoutResponse(e)}async waitForLine(t){return this.queue.length?this.queue.shift():new Promise(e=>{const s=window.setTimeout(()=>{const r=this.notifyWaiters.indexOf(i);r>=0&&this.notifyWaiters.splice(r,1),e(null)},t),i=r=>{clearTimeout(s),e(r)};this.notifyWaiters.push(i)})}async send(t){return this.withLock(async()=>t?(await this.writeLine(t),this.collectLines(q,W)):this.collectLines(q,W))}async sendAndCollect(t,e=q,s=W,i){return this.withLock(async()=>(t&&await this.writeLine(t),this.collectLines(e,s,i)))}async collectLines(t,e,s){const i=[],r=Date.now()+e;for(;Date.now()<r;){const a=r-Date.now(),c=await this.waitForLine(Math.min(t,a));if(c===null){if(i.length)return i;continue}if(i.push(c),s!=null&&s(c,i))return i}return i}disconnect(){var t;this.disconnectUserInitiated=!0,(t=this.server)==null||t.disconnect(),this._connected=!1,this.device=null,this.server=null,this.rxChar=null,this.queue=[],this.notifyWaiters=[],this.opChain=Promise.resolve()}}const ot=250,_t=8e3,xt=5e3,It=200;function lt(n){const t=`OK ${n}`;return e=>e===t||e.startsWith(`${t} `)}function kt(){const n=new Date(new Date().getFullYear(),0,1),t=new Date(new Date().getFullYear(),6,1),e=n.getTimezoneOffset(),s=t.getTimezoneOffset(),i=-e*60,a=e!==s?-Math.min(e,s)*60:0;return`TZ_OFFSET ${i} ${a}`}function Ot(){const n=new Date,t=e=>String(e).padStart(2,"0");return`TIME ${n.getFullYear()}-${t(n.getMonth()+1)}-${t(n.getDate())} ${t(n.getHours())}:${t(n.getMinutes())}:${t(n.getSeconds())}`}function A(n){return n==="REQ_TIME"||n.startsWith("REQ_TIME ")}async function Nt(n){let t=n.drainQueue().some(A);if((await n.send(kt())).some(A)&&(t=!0),!t){const s=Date.now()+2e3;for(;Date.now()<s;){const i=Math.max(100,Math.min(It,s-Date.now())),r=await n.sendAndCollect("",i,Math.min(600,s-Date.now()),a=>A(a));if(r.some(A)){t=!0;break}if(!r.length)break}}}async function Bt(n){await n.send(Ot())}async function R(n){return await Bt(n),Wt(n)}async function P(n){const t=await n.sendAndCollect("SCHED_GET",ot,_t,lt("SCHED_GET"));if(!t.some(e=>e.startsWith("OK SCHED_GET")))throw new Error("SCHED_GET failed");return t}async function Ht(n,t){const e=Object.keys(t);for(const i of e){const r=t[i];let a;if(!r.enabled)a=X(r)?`SCHED_DAY ${i} OFF CLEAR`:`SCHED_DAY ${i} OFF`;else{const d=r.oneShot?" 1":"";a=`SCHED_DAY ${i} ${r.time} ${r.prewindowMin} ${r.pwmMax} ${r.postHoldMin}${d}`}const c=await n.send(a);if(!c.some(d=>d.startsWith("OK SCHED_DAY")))throw new Error(`Failed to set ${i}: ${c.join(" ")}`)}if(!(await n.send("SAVE")).some(i=>i.includes("SAVE ok")))throw new Error("SAVE failed")}function qt(n){const t={};for(const e of n)e.startsWith("RTC: ")&&(t.rtc=e.slice(5)),e.startsWith("TODAY: ")&&(t.today=e.slice(7).trim()),e.startsWith("TODAY_ALARM: ")&&(t.todayAlarm=e.slice(13)),e.startsWith("ALARM(daily): ")&&(t.alarmDaily=e.slice(14)),e.startsWith("ALARM_AT: ")&&(t.alarmAt=e.slice(10)),e.startsWith("NEXT_RAMP: ")&&(t.nextRamp=e.slice(11)),e.startsWith("WAKE_CAUSE: ")&&(t.wakeCause=e.slice(12)),e.startsWith("BOOT_PATH: ")&&(t.bootPath=e.slice(11)),e.startsWith("NVM_OK: ")&&(t.nvmOk=e.includes("yes")),e.startsWith("PHASE: ")&&(t.phase=e.slice(7)),e.startsWith("TIME_SYNC_AUTO: ")&&(t.timeSync=e.slice(16)),e.startsWith("TIME_TRUSTED: ")&&(t.timeTrusted=e.includes("yes")),e.startsWith("PRE(min): ")&&(t.preMin=e.slice(10)),e.startsWith("POST_HOLD(min): ")&&(t.postHoldMin=e.slice(16));return t}async function Wt(n){const t=await n.sendAndCollect("STATUS_LITE",ot,xt,lt("STATUS_LITE"));if(t.some(e=>e.includes("ERR unknown cmd: STATUS_LITE")))return{};if(!t.some(e=>e.startsWith("OK STATUS_LITE")))throw new Error("STATUS_LITE failed");return qt(t)}async function Rt(n,t,e){const s=await n.send(`LAMP_TEST ${t} ${e}`);if(!s.some(i=>i.startsWith("OK LAMP_TEST")))throw new Error(s.find(i=>i.startsWith("ERR"))??"LAMP_TEST failed")}async function Pt(n){const t=await n.send("LAMP_TEST_CANCEL");if(!t.some(e=>e==="OK LAMP_TEST_CANCEL"))throw new Error(t.find(e=>e.startsWith("ERR"))??"LAMP_TEST_CANCEL failed")}function V(){return typeof navigator<"u"&&!!navigator.bluetooth}function Ft(){return/iPad|iPhone|iPod/.test(navigator.userAgent)}function Gt(){return V()}function Ut(){return Ft()&&!V()}function Kt(n){if(!n)return!1;const t=n instanceof DOMException||n instanceof Error?n.name:"",e=n instanceof Error?n.message:String(n),s=e.toLowerCase();return!!(t==="AbortError"||t==="NotFoundError"||s.includes("cancel")||s.includes("abort")||s.includes("chooser")||s.includes("dismiss")||/^\d+$/.test(e.trim()))}function O(){try{return new Intl.DateTimeFormat(void 0,{hour:"numeric"}).resolvedOptions().hour12===!0}catch{return!0}}function _(n){const t=n.match(/^(\d{1,2}):(\d{2})$/);if(!t)return{hour12:7,minute:0,period:"AM"};let e=Number(t[1]);const s=Math.max(0,Math.min(59,Number(t[2])));Number.isFinite(e)||(e=7),e=(e%24+24)%24;const i=e>=12?"PM":"AM";let r=e%12;return r===0&&(r=12),{hour12:r,minute:s,period:i}}function G(n,t,e){let s=n%12;e==="PM"&&(s+=12),e==="AM"&&n===12&&(s=0),e==="PM"&&n===12&&(s=12);const i=Math.max(0,Math.min(59,Math.round(t)));return`${String(s).padStart(2,"0")}:${String(i).padStart(2,"0")}`}function Yt(n,t){const e=(Math.round(n)%24+24)%24,s=Math.max(0,Math.min(59,Math.round(t)));return`${String(e).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function U(n){const{hour12:t,minute:e,period:s}=_(n);return`${t}:${String(e).padStart(2,"0")} ${s}`}function K(n){const t=n.match(/^(\d{1,2}):(\d{2})$/);if(!t)return"07:00";const e=Number(t[1]),s=Number(t[2]);return`${String(e).padStart(2,"0")}:${String(s).padStart(2,"0")}`}function Xt(n,t=O()){return t?U(n):K(n)}function Vt(n,t=O()){const e=n.trim();if(!e)return null;const s=e.match(/^(\d{1,2}):(\d{2})\s*(AM|PM|am|pm)$/i);if(s){const r=Number(s[1]),a=Number(s[2]);if(r<1||r>12||a>59)return null;const c=s[3].toUpperCase()==="PM"?"PM":"AM";return G(r,a,c)}const i=e.match(/^(\d{1,2}):(\d{2})$/);if(i){const r=Number(i[1]),a=Number(i[2]);return r>23||a>59?null:`${String(r).padStart(2,"0")}:${String(a).padStart(2,"0")}`}if(t){const r=e.match(/^(\d{1,2}):(\d{2})$/);if(r){const a=Number(r[1]),c=Number(r[2]);if(a>=1&&a<=12&&c<=59)return G(a,c,a>=7&&a<=11?"AM":"PM")}}return null}const C=10;function jt(n,t){n.querySelectorAll(".alarm-swipe").forEach(e=>{const s=e,i=s.dataset.alarmId;if(!i)return;const r=s.querySelector(".alarm-row-panel"),a=s.querySelector(".alarm-swipe-delete");if(!r)return;let c=0,d=0,u=0,m=!1,p=null,y=null,b=!1;const N=(l,h)=>{r.style.transition=h?"transform 0.22s ease":"none",r.style.transform=l===0?"":`translateX(${l}px)`,s.classList.toggle("open",l<=-44/2)},ct=()=>{n.querySelectorAll(".alarm-swipe").forEach(l=>{const h=l;h.classList.remove("open");const f=h.querySelector(".alarm-row-panel");f&&(f.style.transition="",f.style.transform="")})},D=l=>{l<=-44?(ct(),N(-88,!0),s.classList.add("open")):(N(0,!0),s.classList.remove("open"))};a==null||a.addEventListener("click",l=>{l.stopPropagation(),t.onDelete(i)});const dt=(l,h)=>{u=s.classList.contains("open")?-88:0,c=l,d=h,m=!0,p=null,r.style.transition="none"},ut=(l,h)=>{if(!m)return;const f=l-c,M=h-d;if(p||(Math.abs(f)>C||Math.abs(M)>C)&&(p=Math.abs(f)>Math.abs(M)?"x":"y"),p!=="x")return;let S=u+f;S>0&&(S=0),S<-88&&(S=-88),N(S,!1)},ht=(l,h)=>{if(!m)return;m=!1,y=null;const f=l-c,M=h-d;if(p==="x"){D(u+f),b=!0,window.setTimeout(()=>{b=!1},400);return}if(!(Math.abs(f)>=C||Math.abs(M)>=C)){if(s.classList.contains("open")){D(0);return}t.onTap(i),b=!0,window.setTimeout(()=>{b=!1},400)}};r.addEventListener("pointerdown",l=>{if(l.pointerType==="mouse"&&l.button!==0)return;const h=l.target;h.closest(".alarm-swipe-delete")||h.closest("[data-action='group-toggle']")&&!s.classList.contains("open")||(y=l.pointerId,r.setPointerCapture(l.pointerId),dt(l.clientX,l.clientY))}),r.addEventListener("pointermove",l=>{y===l.pointerId&&(ut(l.clientX,l.clientY),p==="x"&&l.preventDefault())}),r.addEventListener("pointerup",l=>{y===l.pointerId&&(r.hasPointerCapture(l.pointerId)&&r.releasePointerCapture(l.pointerId),ht(l.clientX,l.clientY))}),r.addEventListener("pointercancel",l=>{y===l.pointerId&&(m=!1,y=null,D(s.classList.contains("open")?-88:0))}),r.addEventListener("click",l=>{if(b){l.preventDefault();return}if(s.classList.contains("open")){l.preventDefault(),D(0);return}l.target.closest("[data-action='group-toggle']")||t.onTap(i)})}),n.dataset.alarmSwipeDismissBound||(n.dataset.alarmSwipeDismissBound="1",n.addEventListener("click",e=>{e.target.closest(".alarm-swipe")||x(n)},{capture:!0}))}function x(n){n.querySelectorAll(".alarm-swipe").forEach(t=>{const e=t;e.classList.remove("open");const s=e.querySelector(".alarm-row-panel");s&&(s.style.transition="",s.style.transform="")})}const zt=Array.from({length:12},(n,t)=>t+1),Jt=Array.from({length:24},(n,t)=>t),Qt=Array.from({length:60},(n,t)=>t),Zt=["AM","PM"],te=36;class ee{constructor(t,e,s,i={}){o(this,"root");o(this,"onChange");o(this,"use12Hour");o(this,"hour12");o(this,"hour24");o(this,"minute");o(this,"period");o(this,"typeInput",null);o(this,"hourCol",null);o(this,"minuteCol",null);o(this,"periodCol",null);o(this,"syncing",!1);this.root=t,this.onChange=s,this.use12Hour=i.use12Hour??O();const r=_(e);this.hour12=r.hour12,this.hour24=Number(e.split(":")[0])||7,this.minute=r.minute,this.period=r.period,this.render(),this.syncWheels(!1)}setTime24(t){const e=_(t);this.hour12=e.hour12,this.hour24=Number(t.split(":")[0])||0,this.minute=e.minute,this.period=e.period,this.syncWheels(!1),this.syncTypeField()}getTime24(){return this.use12Hour?G(this.hour12,this.minute,this.period):Yt(this.hour24,this.minute)}destroy(){this.root.innerHTML=""}emit(){const t=this.getTime24();this.syncTypeField(),this.onChange(t)}syncTypeField(){this.typeInput&&(this.typeInput.value=this.use12Hour?U(this.getTime24()):K(this.getTime24()))}placeholder(){return this.use12Hour?"6:30 AM":"18:30"}render(){var e,s,i,r,a,c;const t=this.use12Hour?'<div class="time-wheel-col time-wheel-col-period" data-wheel="period" tabindex="0"></div>':"";if(this.root.innerHTML=`
    ...
    `}renderConnect(){const t=Ut(),e=Gt(),s=window.location.href;return`
      ...
      <div class="alarm-swipe" data-alarm-id="${i}">
        ...
        <div class="alarm-row alarm-row-panel${r}" data-alarm-id="${i}">
          <div class="alarm-row-main">
            <div class="alarm-time">${Xt(e.time,this.use12Hour)}</div>
            <div class="alarm-subtitle">${St(s,e)}</div>
            <div class="alarm-subtitle alarm-subtitle-detail">${Tt(e)}</div>
          </div>
          <div
    ...
    `}renderAlarmEdit(){if(!this.editDraft)return"";const{slot:t,days:e,oneTime:s}=this.editDraft,i=new Set(e),r=s?" repeat-disabled":"";return`
      ...
      ${this.renderActionBar()}
    `}render(){var t;(t=this.timePicker)==null||t.destroy(),this.timePicker=null,this.screen==="connect"?this.root.innerHTML=this.renderConnect():this.screen==="alarm-edit"?this.root.innerHTML=this.renderAlarmEdit():this.root.innerHTML=this.renderEditor(),x(this.root),this.bindEvents()}bindEvents(){if(this.screen==="connect"){this.bindConnectEvents();return}if(this.screen==="alarm-edit"){this.bindAlarmEditEvents();return}this.bindEditorEvents()}bindConnectEvents(){var t;(t=this.root.querySelector("#btn-connect"))==null||t.addEventListener("click",()=>void this.connectBle())}bindActionBarEvents(t){var e,s,i;(e=this.root.querySelector("#btn-disconnect"))==null||e.addEventListener("click",()=>void this.disconnect()),(s=this.root.querySelector("#btn-refresh"))==null||s.addEventListener("click",()=>void this.refreshFromDevice()),(i=this.root.querySelector("#btn-save"))==null||i.addEventListener("click",()=>void t())}bindEditorEvents(){var s,i,r,a,c,d;this.bindActionBarEvents(()=>this.saveToDevice()),(s=this.root.querySelector("#btn-add-alarm"))==null||s.addEventListener("click",()=>this.addAlarm());const t=Z(this.schedule);jt(this.root,{onDelete:u=>void this.deleteAlarmById(u),onTap:u=>this.openAlarmEdit(u)}),this.root.querySelectorAll("[data-action='group-toggle']").forEach(u=>{u.addEventListener("click",m=>{const p=u.dataset.alarmId,y=t.find(b=>b.id===p);y&&this.toggleGroupEnabled(y,m)})}),(i=this.root.querySelector("#btn-lamp-test-toggle"))==null||i.addEventListener("click",()=>{this.toggleLampTestPanel()}),(r=this.root.querySelector("#lamp-test-level"))==null||r.addEventListener("input",u=>{this.syncLampTestSlider(Number(u.target.value))});const e=this.root.querySelector("#lamp-test-level-num");e==null||e.addEventListener("input",()=>this.onLampTestNumberInput(e)),e==null||e.addEventListener("change",()=>this.commitLampTestNumber(e)),e==null||e.addEventListener("blur",()=>this.commitLampTestNumber(e)),(a=this.root.querySelector("#lamp-test-seconds"))==null||a.addEventListener("change",u=>{const m=u.target;this.lampTestSeconds=j(Number(m.value)),m.value=String(this.lampTestSeconds);const p=this.root.querySelector("#btn-lamp-test");p&&(p.textContent=`Try for ${this.lampTestSeconds}s`)}),(c=this.root.querySelector("#btn-lamp-test"))==null||c.addEventListener("click",()=>void this.tryLampBrightness()),(d=this.root.querySelector("#btn-lamp-cancel"))==null||d.addEventListener("click",()=>{this.cancelLampTestOnDevice(!0),this.setMessage("Brightness test cancelled.","ok")})}bindAlarmEditEvents(){var s,i,r,a,c;if(!this.editDraft)return;const t=this.root.querySelector("#time-wheel-mount");t&&(this.timePicker=new ee(t,this.editDraft.slot.time,d=>{this.editDraft&&(this.editDraft.slot.time=d)},{use12Hour:this.use12Hour})),(s=this.root.querySelector("#btn-repeat-once"))==null||s.addEventListener("click",()=>this.toggleEditOneTime()),(i=this.root.querySelector("#btn-edit-cancel"))==null||i.addEventListener("click",()=>this.closeAlarmEdit(!1)),(r=this.root.querySelector("#btn-edit-done"))==null||r.addEventListener("click",()=>void this.saveAlarmEditToDevice()),this.bindActionBarEvents(()=>this.saveAlarmEditToDevice()),(a=this.root.querySelector("#btn-delete-alarm"))==null||a.addEventListener("click",()=>{window.confirm("Delete this alarm?")&&this.deleteEditingAlarm()}),this.root.querySelectorAll("[data-repeat-day]").forEach(d=>{d.addEventListener("click",()=>{const u=d.dataset.repeatDay;this.toggleEditDay(u)})}),(c=this.root.querySelector("#edit-pwm-range"))==null||c.addEventListener("input",d=>{this.setEditBrightnessFromSlider(Number(d.target.value))});const e=this.root.querySelector("#edit-pwm-num");e==null||e.addEventListener("input",()=>this.onEditBrightnessNumberInput(e)),e==null||e.addEventListener("change",()=>this.commitEditBrightnessNumber(e)),e==null||e.addEventListener("blur",()=>this.commitEditBrightnessNumber(e))}}const et=document.getElementById("app");et&&new se(et);
